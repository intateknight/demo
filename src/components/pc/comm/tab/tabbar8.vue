    ...
    <div style="float: right;margin-top: 10px;margin-right: 10px;">
      <div class="right mr40" >
        <div style="display:flex">
          <el-select v-model="type" placeholder="请选择门店" >
            <el-option label="门店一" value="shanghai"></el-option>
            <el-option label="门店二" value="beijing"></el-option>
          </el-select>
          <el-button type="primary" size="mini" class="ml20 blue" icon="el-icon-circle-plus-outline" @click="postdata">新增监控设备</el-button>
        </div>
    </div>
  </div>
