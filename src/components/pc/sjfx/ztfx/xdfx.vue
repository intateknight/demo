<template>
  <div>
    <div class="title" style="height:46px;font-size:14px;padding: 0 40px;">
      ...
      <div style="width:60px">巡店次数</div>
      <div style="width:70px">现场巡店数</div>
      <div style="width:70px">远程巡店数</div>
      <div style="width:70px">视频巡店数</div>
      <div style="width:60px">巡店人数</div>
      <div style="width:60px">总问题数</div>
      <div style="width:70px">逾期问题数</div>
      <div style="width:90px">待整改问题数</div>
      <div style="width:90px">待复检问题数</div>
      <div style="width:90px">已整改问题数</div>
      <div style="width:70px">整改完成率</div>
      <div style="width:50px">逾期率</div>
    </div>
    <div class="loop">
      <div class="contain" style="height:60px;font-size:14px;padding: 20px 40px;width: 100%;" v-for="item in list" :key="item.id">
        ...
        <div style="width:60px">{{ item.frequency }}</div>
        <div style="width:70px">{{ item.scene }}</div>
        <div style="width:70px">{{ item.remote }}</div>
        <div style="width:70px">{{ item.video }}</div>
        <div style="width:60px">{{ item.number }}</div>
        <div style="width:60px">{{ item.problem }}</div>
        <div style="width:70px">{{ item.overdue }}</div>
        <div style="width:90px">{{ item.rectify }}</div>
        <div style="width:90px">{{ item.recheck  }}</div>
        <div style="width:90px">{{ item.rectified }}</div>
        <div style="width:70px">{{ item.completionrate }}</div>
        <div style="width:50px">{{ item.overduelaw }}</div>
      </div>
    </div>
