  ...
  <div class="bgc">
    ...
    <div :class="['container', 'container-register', { 'is-txl': isLogin }]">
      <form>
        ...
        <input class="form__input" type="text" placeholder="Name" :value='registerForm.name'/>
        <input class="form__input" type="text" placeholder="Email" :value='registerForm.email'/>
        <input class="form__input" type="password" placeholder="Password" :value='registerForm.password'/>
    ...
    >
      <form>
        ...
        <span class="text">or use email for registration</span>
        <input class="form__input" type="text" placeholder="Email" :value='loginForm.email'/>
        <input class="form__input" type="password" placeholder="Password" :value='loginForm.password'/>
